            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button 
                  ...
                  onClick={() => window.open(`https://wa.me/254735808068?text=${whatsappMessage}`, '_blank')}
                >
                ...
                <Button 
                  ...
                  onClick={() => window.open('tel:+254735808068')}
                >
